...
{
	.RenderGetParm = pfnRenderGetParm,
	.GetDetailScaleForTexture = NULL,
	.GetExtraParmsForTexture = NULL,
	.GetLightStyle = CL_GetLightStyle,
	.GetDynamicLight = CL_GetDynamicLight,
	.GetEntityLight = CL_GetEntityLight,
	.LightToTexGamma = LightToTexGamma,
	.GetFrameTime = NULL,

	.R_SetCurrentEntity = NULL,
	.R_SetCurrentModel = NULL,
	.R_FatPVS = R_FatPVS,
	...
	.GL_TextureData = NULL,
	.GL_LoadTexture = NULL,
	.GL_CreateTexture = NULL,
	.GL_LoadTextureArray = NULL,
	.GL_CreateTextureArray = NULL,
	.GL_FreeTexture = NULL,

	.DrawSingleDecal = NULL,
	.R_DecalSetupVerts = NULL,
	.R_EntityRemoveDecals = NULL,

	.AVI_LoadVideo = AVI_LoadVideo,
	.AVI_GetVideoInfo = AVI_GetVideoInfo,
	.AVI_GetVideoFrameNumber = AVI_GetVideoFrameNumber,
	.AVI_GetVideoFrame = AVI_GetVideoFrame,
	.AVI_UploadRawFrame = NULL,
	.AVI_FreeVideo = AVI_FreeVideo,
	.AVI_IsActive = AVI_IsActive,
	.AVI_StreamSound = pfnAVI_StreamSound,
	.AVI_Think = AVI_Think,
	.AVI_SetParm = AVI_SetParm,

	.GL_Bind = NULL,
	.GL_SelectTexture = NULL,
	.GL_LoadTextureMatrix = NULL,
	.GL_TexMatrixIdentity = NULL,
	.GL_CleanUpTextureUnits = NULL,
	.GL_TexGen = NULL,
	.GL_TextureTarget = NULL,
	.GL_TexCoordArrayMode = NULL,
	.GL_GetProcAddress = NULL,
	.GL_UpdateTexSize = NULL,
	.GL_Reserved0 = NULL,
	.GL_Reserved1 = NULL,

	.GL_DrawParticles = NULL,
	.EnvShot = R_EnvShot,
	.SPR_LoadExt = pfnSPR_LoadExt,
	.LightVec = NULL,
	.StudioGetTexture = NULL,
	.GetOverviewParms = GL_GetOverviewParms,
	.GetFileByIndex = CL_GenericHandle,
	.pfnSaveFile = COM_SaveFile,
	.R_Reserved0 = NULL,

	.pfnMemAlloc = R_Mem_Alloc,
	.pfnMemFree = R_Mem_Free,

	.pfnGetFilesList = CL_GetFilesList,
	.pfnFileBufferCRC32 = pfnFileBufferCRC32,
	.COM_CompareFileTime = pfnCompareFileTime,
	.Host_Error = Host_Error,
	.pfnGetModel = (void*)CL_ModelHandle,
	.pfnTime = Sys_FloatTime,
	.Cvar_Set = Cvar_Set,
	.S_FadeMusicVolume = S_FadeMusicVolume,
	.SetRandomSeed = COM_SetRandomSeed,
};
